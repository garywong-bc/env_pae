		...
		<div id="header-main-row1">
			<div id="site-logo">
				<a href="http://www2.gov.bc.ca/">
					<img id="bc-logo" src="/pae/sites/all/themes/parks/images/logos/logo-bc.png" alt="Government of B.C." title="Government of B.C.">
				</a>
				<img id="bcparks-text" src="/pae/sites/all/themes/parks/images/logos/logo-bcparks-text.png" alt="BC Parks" title="BC Parks">
