...
ini_set('memory_limit', '192M');   // 12-DEC-2017 GW 128->256
 ...
 *
 */
$drupal_hash_salt = 'qf6Ej_iCxWIN7lcpaCtAcWB_bzjdHVTBsuQQWh5BI6U';
...
$base_url = 'https://apps.nrs.gov.bc.ca/pae';  // NO trailing slash!
...
$conf['file_temporary_path'] = '/fs/u02/ofs/inetpub/ahte_pae/pae/sites/default/files/tmp';
...
/* 2016-FEB-01 GW As per CSNR Infrastructure & MiddleWare update */
$conf['proxy_server'] = 'forwardproxy.nrs.bcgov';
$conf['proxy_port'] = '23128';
 ...
 */
$conf['reverse_proxy_addresses'] = array('142.34.223.242','142.34.223.240','142.34.138.80', '142.34.138.81', '142.34.161.42');
